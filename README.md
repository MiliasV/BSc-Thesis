...
_Example figure: 1000 autonomous systems - 20 clusters. Each color represent a different cloud infrastructure which was responsible for the building of those AS-nodes.  In the middle the AS which contains the victim._
